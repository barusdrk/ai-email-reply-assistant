...
export default function Billing() {
  ...
  if (loading) {
    return <div className="p-6 text-(--text)">Loading billing information...</div>;
  }
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 text-(--text-secondary)">Choose the plan that fits your AI email workflow.</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="mt-6 space-y-3 text-sm">
                <p className="font-medium text-(--text)">{plan.replies}</p>

                <div>
                  <p className="font-medium text-(--text)">Available AI providers</p>
              ...
              <ul className="mt-6 space-y-3">
                {plan.features.map((feature) => (
                  <li key={feature} className="flex gap-2 text-sm text-(--text-secondary)">
                    <span className="font-bold text-(--info-text)">✓</span>
                    {feature}
                  </li>
                ))}
              </ul>
